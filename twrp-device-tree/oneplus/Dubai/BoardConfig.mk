...
DEVICE_PATH := device/oneplus/Dubai
...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := Oneplus-AP-M216
...
BOARD_KERNEL_CMDLINE := quiet no_autorun_log=1 loglevel=1 dbg_mutex=0 androidboot.boot_devices=mstar_mci.0 buildvariant=user
...
TARGET_KERNEL_SOURCE := kernel/oneplus/Dubai
...
BOARD_BOOTIMAGE_PARTITION_SIZE := 32505856
